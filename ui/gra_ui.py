        ...
        with gr.Tabs():
            for idx in range(1, 5):  # 创建 4 个标签页
                with gr.TabItem(f"设备 {idx}"):
                    ...
                    def submit_config(delay_ms, offset_px, mode1_val, max_runtime_val, mode2_val, accel_val, i=idx-1):
                        try:
                    ...
                    submit_btn.click(fn=submit_config, inputs=[delay, click_offset, mode1, max_runtime, mode2, accel], outputs=ot3)
